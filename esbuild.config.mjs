...
const options = {
    ...
    treeShaking: true,
    outfile: '/Users/sethmcgaugh/Documents/spec-stories/.obsidian/plugins/lineage/main.js',
    plugins: [
...
const cssOptions = {
    ...
    bundle: true,
    outfile: '/Users/sethmcgaugh/Documents/spec-stories/.obsidian/plugins/lineage/styles.css',
};
